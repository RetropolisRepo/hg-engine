...
u16 sGoldenrodDepartment5F[] = {
    ITEM_TM042, ITEM_TM017, ITEM_TM054, ITEM_POTION, ITEM_TM016, ITEM_TM033, ITEM_TM022, ITEM_TM052, ITEM_TM038, ITEM_TM025, ITEM_TM014, ITEM_TM015, 0xFFFF
};
...
const struct MartItem sPokeathlonShop_Sunday[] = {
    { ITEM_RED_APRICORN, 50 },
    { ITEM_BLUE_APRICORN, 50 },
    { ITEM_BLACK_APRICORN, 50 },
    { ITEM_ABILITY_CAPSULE, 500 },
    { ITEM_KINGS_ROCK, 1200 },
...
const struct MartItem sPokeathlonShop_Monday[] = {
    { ITEM_RED_APRICORN, 50 },
    { ITEM_BLUE_APRICORN, 50 },
    { ITEM_GREEN_APRICORN, 50 },
    { ITEM_ABILITY_CAPSULE, 500 },
    { ITEM_MOON_STONE, 1200 },
    { ITEM_RARE_CANDY, 1000 },
    { 0xFFFF, 0 },
};

const struct MartItem sPokeathlonShop_Tuesday[] = {
    { ITEM_YELLOW_APRICORN, 50 },
    { ITEM_PINK_APRICORN, 50 },
    { ITEM_WHITE_APRICORN, 50 },
    { ITEM_ABILITY_CAPSULE, 500 },
    { ITEM_FIRE_STONE, 1000 },
    { ITEM_PP_UP, 500 },
    { 0xFFFF, 0 },
};
...
const struct MartItem sPokeathlonShop_NatdexSunday[] = {
    ...
    { ITEM_KINGS_ROCK, 1200 },
    { ITEM_HEART_SCALE, 200 },
    { ITEM_FULL_RESTORE, 200 },
    { ITEM_NUGGET, 500 },
    { ITEM_SUN_STONE, 1200 },
    { ITEM_FIRE_STONE, 1000 },
    { ITEM_SHINY_STONE, 1200 },
    { ITEM_DAWN_STONE, 1200 },
    { 0xFFFF, 0 },
};
